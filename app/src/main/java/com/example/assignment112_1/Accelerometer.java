...
public class Accelerometer {
    ...
    public Accelerometer(Context context, CommonSensor barometer, CommonSensor thermometer) {
        ...
        if (!standardAccelerometerAvailable()) {
            ...
            mAccelerationListener = new SensorEventListener() {
                ...
                public void onSensorChanged(SensorEvent event) {
                    ...
                    if (deltaX > 0 || deltaY > 0 || deltaZ > 0) {
                        ...
                        if (!barometer.isStarted())
                            barometer.startSensing(Accelerometer.this);
                        if (!thermometer.isStarted())
                            thermometer.startSensing(Accelerometer.this);
                ...
                public void onAccuracyChanged(Sensor sensor, int accuracy) {
                    Log.i(TAG, "Accuracy changed to " + accuracy + " for accelerometer");
                }
            };
        }
    }
    ...
    public void startAccelerometerRecording() {
        ...
        if (standardAccelerometerAvailable()) {
            ...
            Log.i(TAG, "accelerometer unavailable or already active");
        }
    }


    /**
     * this stops the accelerometer
     */
